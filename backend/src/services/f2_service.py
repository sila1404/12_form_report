...
class F2:
    ...
    def second_report(self) -> dict[str, int]:
        report_1 = get_closing_balance_debit(self.file, 133111 ) 
    ...
    def eighth_report(self)-> dict[str, int]:
        report_2 = get_closing_balance_debit(self.file, 1441 ) 
        - get_closing_balance_debit(self.file, 14821)
        report_3 = get_closing_balance_debit(self.file, 1442) 
    ...
    def tenth_report(self) -> dict[str, int]:
        report_1 = get_closing_balance_debit(self.file, 12837) 
        + get_closing_balance_debit(self.file, 12037 ) 
        + get_closing_balance_debit(self.file, 1297) 
        report_3 = get_closing_balance_debit(self.file, 136137) 
    ...
    def fifteenth_report(self) -> dict[str, int]: 
        report_1 = get_closing_balance_debit(self.file, 2137) 
    ...
    def sixteenth_report(self) -> dict[str, int]: 
        ...
        report_5 = get_closing_balance_debit(self.file, 3204) + get_closing_balance_debit(self.file, 3208)
        report_9 = get_closing_balance_debit(self.file, 3908)
        report_11 = get_closing_balance_debit(self.file ,3701)
        self.total_sixteenth = report_1 + report_3 + report_4 + report_5 + report_9 + report_11
        return{
